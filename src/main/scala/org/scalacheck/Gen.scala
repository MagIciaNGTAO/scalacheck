...
object Gen {
   ...
   */
  def containerOfN[C[_], T](n: Int, g: Gen[T])(implicit evb: Buildable[T, C], evt: C[T] => Traversable[T]): Gen[C[T]] =
   ...
   */
  def containerOf[C[_], T](g: Gen[T])(implicit evb: Buildable[T, C], evt: C[T] => Traversable[T]): Gen[C[T]] =
   ...
   *  generating values.
   */
  def nonEmptyContainerOf[C[_], T](g: Gen[T])(implicit evb: Buildable[T, C], evt: C[T] => Traversable[T]): Gen[C[T]] =
  ...
  def containerOf1[C[_], T](g: Gen[T])(implicit evb: Buildable[T, C], evt: C[T] => Traversable[T]): Gen[C[T]] = nonEmptyContainerOf[C, T](g)
   ...
   */
  def containerOfN[C[_, _], T, U](n: Int, g: Gen[(T, U)])(implicit evb: Buildable2[T, U, C], evt: C[T, U] => Traversable[(T, U)]): Gen[C[T, U]] =
   ...
   *  container is bounded by the size parameter used when generating values.
   */
  def containerOf[C[_, _], T, U](g: Gen[(T, U)])(implicit evb: Buildable2[T, U, C], evt: C[T, U] => Traversable[(T, U)]): Gen[C[T, U]] =
   ...
   */
  def nonEmptyContainerOf[C[_, _], T, U](g: Gen[(T, U)])(implicit evb: Buildable2[T, U, C], evt: C[T, U] => Traversable[(T, U)]): Gen[C[T, U]] =
  ...
  def pick[T](n: Int, g1: Gen[T], g2: Gen[T], gn: Gen[T]*): Gen[Seq[T]] = {
    ...
    pick(n, 0 until gs.size).flatMap(idxs =>
      sequence[List, T](idxs.toList.map(gs(_)))).suchThat(_.forall(x => gs.exists(_.sieveCopy(x))))
  }
  ...
  def chooseNum[T](minT: T, maxT: T, specials: T*)(
    implicit num: Numeric[T], c: Choose[T]): Gen[T] = {
    import num._
   ...
   *  parameters.
   */
  def resultOf[T1, T2, R](f: (T1, T2) => R)(implicit a1: Arbitrary[T1], a2: Arbitrary[T2]): Gen[R] = arbitrary[T1] flatMap { t => resultOf(f(t, _: T2)) }
   ...
   *  parameters.
   */
  def resultOf[T1, T2, T3, R](f: (T1, T2, T3) => R)(implicit a1: Arbitrary[T1], a2: Arbitrary[T2], a3: Arbitrary[T3]): Gen[R] = arbitrary[T1] flatMap { t => resultOf(f(t, _: T2, _: T3)) }
   ...
   *  parameters.
   */
  def resultOf[T1, T2, T3, T4, R](f: (T1, T2, T3, T4) => R)(implicit a1: Arbitrary[T1], a2: Arbitrary[T2], a3: Arbitrary[T3], a4: Arbitrary[T4]): Gen[R] = arbitrary[T1] flatMap {
   ...
   *  parameters.
   */
  def resultOf[T1, T2, T3, T4, T5, R](f: (T1, T2, T3, T4, T5) => R)(implicit a1: Arbitrary[T1], a2: Arbitrary[T2], a3: Arbitrary[T3], a4: Arbitrary[T4],
    a5: Arbitrary[T5]): Gen[R] = arbitrary[T1] flatMap {
  ...
  def resultOf[T1, T2, T3, T4, T5, T6, R](
    f: (T1, T2, T3, T4, T5, T6) => R)(implicit a1: Arbitrary[T1], a2: Arbitrary[T2], a3: Arbitrary[T3],
      a4: Arbitrary[T4], a5: Arbitrary[T5], a6: Arbitrary[T6]): Gen[R] = arbitrary[T1] flatMap {
  ...
  def resultOf[T1, T2, T3, T4, T5, T6, T7, R](
    f: (T1, T2, T3, T4, T5, T6, T7) => R)(implicit a1: Arbitrary[T1], a2: Arbitrary[T2], a3: Arbitrary[T3],
      a4: Arbitrary[T4], a5: Arbitrary[T5], a6: Arbitrary[T6], a7: Arbitrary[T7]): Gen[R] = arbitrary[T1] flatMap {
  ...
  def resultOf[T1, T2, T3, T4, T5, T6, T7, T8, R](
    f: (T1, T2, T3, T4, T5, T6, T7, T8) => R)(implicit a1: Arbitrary[T1], a2: Arbitrary[T2], a3: Arbitrary[T3], a4: Arbitrary[T4],
      a5: Arbitrary[T5], a6: Arbitrary[T6], a7: Arbitrary[T7], a8: Arbitrary[T8]): Gen[R] = arbitrary[T1] flatMap {
  ...
  def resultOf[T1, T2, T3, T4, T5, T6, T7, T8, T9, R](
    f: (T1, T2, T3, T4, T5, T6, T7, T8, T9) => R)(implicit a1: Arbitrary[T1], a2: Arbitrary[T2], a3: Arbitrary[T3], a4: Arbitrary[T4],
      a5: Arbitrary[T5], a6: Arbitrary[T6], a7: Arbitrary[T7], a8: Arbitrary[T8],
      a9: Arbitrary[T9]): Gen[R] = arbitrary[T1] flatMap {
